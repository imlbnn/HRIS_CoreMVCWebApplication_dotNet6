    ...
    public partial class InitializedDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CivilStatus", x => x.Code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SerialID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmpID = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false, computedColumnSql: "FORMAT([DateOfBirth],  'ddMMyy') + '-' + FORMAT([SerialID], '000000000')"),
                    ...
                    CivilStatusCode = table.Column<string>(type: "nvarchar(2)", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
